...
user3 = User.create! :email => "cc@dd.com", :password => 'topsecret', :password_confirmation => 'topsecret', :username => 'test2', :bio => 'great tester2', :gender => 'female', :postcode => 'NG11 3DX', :location => 'Beeston', :interested_in => 'male', :image File.new("public/system/users/images/000/000/012/original/CheeryChar.jpg")
